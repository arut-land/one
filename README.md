...
One product, native on every device, executed on whichever of your nodes you choose.

- [CONTEXT.md](CONTEXT.md): product language
- [ARCHITECTURE.md](ARCHITECTURE.md): target design and repository boundaries
