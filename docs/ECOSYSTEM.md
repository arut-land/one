...
| gtk4 / gdk4 | 0.11.4 (2026-06-29) | MIT | Linux | ADOPT NOW | Already in `surfaces/linux`. Bump the dep to enable `v4_20` for `gtk_interface_color_scheme()` and `gtk_interface_contrast()`. |
