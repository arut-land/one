...
description: Build or review React web interfaces using @fluentui/react-components v9, FluentProvider, and Griffel tokens. Use when the web surface uses or requests Fluent React; native WinUI tasks use the Windows skills.
---
