...
composer-placeholder = Message Arut
...
chat-status-failed = Could not send the message. Try again.
composer-status-connecting = Connecting draft…
composer-status-failed = Could not synchronize the draft. Check the node connection.

## Feature availability, as reported by the node's capability manifest

availability-unknown = Checking node availability…
